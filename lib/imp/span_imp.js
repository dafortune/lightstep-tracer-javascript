...
var SpanImp = function (_opentracing$Span) {
    ...
    _createClass(SpanImp, [{
        ...
        value: function _addTags(keyValuePairs) {
            var self = this;
            Object.keys(keyValuePairs).forEach(function (value, key) {
                self._tags.set(key, value);
            });
        }
    }, {
        key: '_log',
    ...
    _createClass(SpanImp, [{
        ...
        value: function parentGUID() {
            return this._tags.get('parent_span_guid');
        }
    }, {
        key: 'setParentGUID',
        ...
        value: function getTags() {
          const obj = {};
          this._tags.forEach ((v,k) => { obj[k] = v });
          return obj;
        }
        ...
        value: function end(finishTime) {
            ...
            if (this._endMicros === 0) {
                this._endMicros = Date.now() * 1000;//this._tracerImp._platform.nowMicros();
            }
